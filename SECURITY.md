...
Use [GitHub's private vulnerability reporting](https://github.com/{{owner}}/draftkit/security/advisories/new)
...
- The draftkit CLI tool
- The draftkit-core library
...
Thank you for helping keep draftkit secure!
